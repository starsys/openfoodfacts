...
# make_simple_query("""DELETE FROM category;""", method="insert")
...
# checking if category or product tables are not empty or if the category.txt data is different from the existing SQL "category" table
